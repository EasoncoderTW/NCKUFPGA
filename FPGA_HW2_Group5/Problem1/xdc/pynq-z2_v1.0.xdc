...
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 } [get_ports {rgb4[0]}]
set_property -dict { PACKAGE_PIN G17 IOSTANDARD LVCMOS33 } [get_ports {rgb4[1]}]
set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33 } [get_ports {rgb4[2]}]
set_property -dict { PACKAGE_PIN G14 IOSTANDARD LVCMOS33 } [get_ports {rgb5[0]}]
set_property -dict { PACKAGE_PIN L14 IOSTANDARD LVCMOS33 } [get_ports {rgb5[1]}]
set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 } [get_ports {rgb5[2]}]
...
#set_property MARK_DEBUG true [get_nets design_1_i/B_out]
#set_property MARK_DEBUG true [get_nets {design_1_i/sw[0]}]
#set_property MARK_DEBUG true [get_nets {design_1_i/sw[1]}]
#set_property MARK_DEBUG true [get_nets design_1_i/G_out]
#set_property MARK_DEBUG true [get_nets design_1_i/R_out]
...
#connect_debug_port u_ila_0/probe0 [get_nets [list {design_1_i/sw[0]} {design_1_i/sw[1]}]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
#set_property port_width 1 [get_debug_ports u_ila_0/probe1]
#connect_debug_port u_ila_0/probe1 [get_nets [list design_1_i/B_out]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
#set_property port_width 1 [get_debug_ports u_ila_0/probe2]
#connect_debug_port u_ila_0/probe2 [get_nets [list design_1_i/G_out]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
#set_property port_width 1 [get_debug_ports u_ila_0/probe3]
#connect_debug_port u_ila_0/probe3 [get_nets [list design_1_i/R_out]]
